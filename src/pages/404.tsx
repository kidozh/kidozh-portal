...
const Index: React.FunctionComponent<PageProps> = ({
  data: {
    allSitesEnYaml: { edges: sitesEn },
    allSitesZhYaml: { edges: sitesZh },
    site: { siteMetadata },
  },
}) => {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:site_name" content="kidozh.com" />
        ...
        <meta name="twitter:creator" content="@kidozh" />
      ...
      <Page>
        <Header />
        <SliderWrapper>
          <Heading><FormattedMessage id="overview" /></Heading>
          <Grid>
            {sites.map(site => {
                ...
                <Item key={id}>
                  <ItemContent>
                    <Top>
                      ...
                      <FormattedMessage id="preview" /> <img src={rightArrow} alt="Arrow" aria-hidden="true" />
                      </Preview>
                      <Repo href={url}>
        ...
        <Content>
          <Heading><FormattedMessage id="contact" /></Heading>
          <Description>
            <p>
            <FormattedMessage id="contact_detail" />
            </p>
          </Description>
          <Description long={true}>
          <FormattedMessage id="contact_detail_2" />
          </Description>
        </Content>
        <Footer>
